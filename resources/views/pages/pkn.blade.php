...
<div class="container-fluid" style="padding-top: 20px;">
    <div class="row">
      <div class="col-md-12">
        <center>
          <h4>PENDIDIKAN KEWARGANEGARAAN</h4><hr>
        </center>
        ...
        <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <form method="post" action="/pkn/import_excel" enctype="multipart/form-data">
        ...
        <a href="/pkn/export_excel" class="btn btn-success my-3" target="_blank">EXPORT EXCEL</a>
